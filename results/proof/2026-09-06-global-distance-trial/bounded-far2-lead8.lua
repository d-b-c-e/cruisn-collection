...
local first = tonumber(os.getenv('CRUISN_DISTANCE_FIRST') or '5900')
local last = tonumber(os.getenv('CRUISN_DISTANCE_LAST') or '6140')
local far = tonumber(os.getenv('CRUISN_DISTANCE_FAR') or '160000')
