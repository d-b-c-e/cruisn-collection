...
| **B2** | Telemetry Phase B — RPM | ◐ | M | ⚠️ | **crusnusa DONE 2026-08-23** (0x0DC20, confirmed from a real drive: tracks speed then V-dips at the Hi/Lo shift while speed stays flat; wired + live-verified over UDP, 0→~912). Attract candidate 0x0F0C0 was debunked. **World/Off Road open**: each needs its own driving capture (harness/capture_drive.py <rom>) - RAM layouts differ; method proven. |
