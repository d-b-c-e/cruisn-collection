...
| **B2** | Telemetry Phase B — RPM | ◐ | S | ⚠️ | crusnusa CONFIRMED + wired (0x0E632.lo16, r=+0.91 vs tach). World hunt attempted 2026-08-26: inconclusive - only 7 OCR+ramdump-aligned race frames in the volume-session captures and the tach-arc fill metric barely varied (region needs recalibrating from a race frame). Needs one dedicated capture: 2-3 standing-start full-throttle runs holding gears, no menu time. Off Road same protocol once its HUD box is validated. |
