...
personal renderer is the accepted UX707 lineage, and public v0.5.0 is
unchanged. No unattended force-feedback or release validation is implied by
the diagnostic results below.
...
| Off-Road | Continuous 3× and El Paso restart qualify. In a matched 11-frame sharp turn, 3× changes 529–37,898 completed pixels per frame and partly covers distant sky while preserving all 3,200 recorded inputs. Source/display joins at 3120 and 3136 both find an uncovered center. | A moving left-margin blue opening remains. Differently textured host terrain and original ground do not meet; simple pixel fills and the qualified static billboard class cannot repair it. Other courses and final visual acceptance remain open. |
...
completed 3120 is joined to preparation 3116 and the original DMA page; the
original near-ground quad and host terrain stop on opposite sides of the
opening. At 3136, source 3132 is likewise joined to the completed page, and
the sampled center still has no projected host polygon. The strict indexed
screen finds 5,841 and 7,438 host-bounded sky pixels at those two frames;
...
1. For Off-Road, compare source-joined frames 3116 and 3132 to determine which
   surface should continue as the wedge grows. A candidate must preserve
   ...
   is useful later, but the current recorded
   El Paso drive is sufficient for the immediate source question.
...
3. For Exotica, reuse the stable-1440 native006 results. A changed hypothesis
   ...
   boundary rather than adding more offscreen polygons.
4. After candidate policy and course coverage settle, run integrated launcher,
...
[Exotica transition](2026-09-16-exotica-race-transition.md),
[Exotica stable 1440p](2026-09-23-exotica-lifetime-stutter.md),
[Hawaii rejected skirt](2026-09-23-world-hawaii-skirt-trial.md),
[Off-Road source](2026-09-23-offroad-left-margin-source.md), and
[Off-Road temporal comparison](2026-09-23-offroad-margin-temporal.md).
