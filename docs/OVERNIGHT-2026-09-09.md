...
| World 2.5 | Offline host prototype matches4,390 future descriptors and1,251 later allocations, with independently matching2x/3x projections. No integrated native host option yet. | Promote explicit revision layout and guards, broaden snapshots/frontiers and run stock/2x/3x/repeat gameplay controls; then verify its road path. |
