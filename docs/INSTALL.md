...
| **Distant Scenery** | World 2.4, widescreen, scale2×+ | Draws three verified Germany mountain models and four tree variants earlier. Preserves the mountains' later shape. Experimental and limited to identified scenery; larger forest groups and remaining pop-in are still being investigated. |
